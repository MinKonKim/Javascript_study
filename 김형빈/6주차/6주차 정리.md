...
fruits.forEach(function (fruit) {
  ...
  $li.innerText = fruit;
  $li.addEventListener("click", function (fruit) {
...
```
- 위의 코드를 조금 더 알아보기 쉽게 변수명을 변경하였다.
...
- `alertFruitBuilder`의 내부 function의 outerEnvironmentReference에서 
